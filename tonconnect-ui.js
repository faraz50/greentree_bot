console.log("✅ TonConnect UI script is executing...");
...
if (typeof TonConnectUI !== "undefined") {
    ...
    console.log("✅ TonConnectUI is now globally accessible!");
} else {
    console.error("❌ TonConnectUI is still undefined inside tonconnect-ui.js!");
}
